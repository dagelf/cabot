        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "frequency",
                    models.IntegerField(
                        default=5, help_text="Minutes between each check."
                    ),
                ),
                (
                    "debounce",
                ...
                (
                    "username",
                    models.TextField(
                        blank=True, help_text="Basic auth username.", null=True
                    ),
                ),
                (
                    "password",
                    models.TextField(
                        blank=True, help_text="Basic auth password.", null=True
                    ),
                ),
                (
                    "text_match",
