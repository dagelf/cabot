    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cancelled_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='cancelleduser_set', to='auth.user')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jenkins_config', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cabotapp.jenkinsconfig')),
            ],
            options={
                'abstract': False,
                'base_manager_name': 'objects',
